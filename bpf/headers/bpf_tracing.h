...
#define ___bpf_treg_cnt(t) \
	__builtin_choose_expr(sizeof(t) == 1, 1, \
		__builtin_choose_expr(sizeof(t) == 2, 1, \
			__builtin_choose_expr(sizeof(t) == 4, 1, __builtin_choose_expr(sizeof(t) == 8, 1, __builtin_choose_expr(sizeof(t) == 16, 2, (void)0)))))
...
#define BPF_KSYSCALL(name, args...) \
	...
	typeof(name(0)) name(struct pt_regs *ctx) { \
		...
		_Pragma("GCC diagnostic push") \
			_Pragma("GCC diagnostic ignored \"-Wint-conversion\"") if (LINUX_HAS_SYSCALL_WRAPPER) return ____##name(___bpf_syswrap_args(args)); \
